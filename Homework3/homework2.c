...
int main(int argc, char **argv){
    double* bisect_array_1 = bisection(poly_function,0,1);
    double* bisect_array_2 = bisection(poly_function,-3,-2);
    double* bisect_array_3 = bisection(poly_function,1,2);
    ...
    printf("Root 1 %.14f \n",newt_raph(poly_function,bisect_array_1[2],bisect_array_1[1]));
    printf("Root 2 %.14f \n",newt_raph(poly_function,bisect_array_2[2],bisect_array_2[1]));
    printf("Root 3 %.14f \n",newt_raph(poly_function,bisect_array_3[2],bisect_array_3[1]));
